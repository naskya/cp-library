...
data:
  ...
  bundledCode: "#line 1 \"test/data_structure/segment_tree/3.test.cpp\"\n#define PROBLEM\
    \ \"https://atcoder.jp/contests/abc194/tasks/abc194_e\"\n#include <algorithm>\n\
    ...
    #endif  // CP_LIBRARY_SEGMENT_TREE_HPP\n#line 8 \"test/data_structure/segment_tree/3.test.cpp\"\
    \n\nint main() {\n  int N, M;\n  std::cin >> N >> M;\n\n  std::vector<int> A(N);\n\
    \  std::copy_n(std::istream_iterator<int>(std::cin), N, std::begin(A));\n\n  const\
    \ auto op            = [](const auto& x, const auto& y) constexpr { return std::min(x,\
  ...
  verifiedWith: []
documentation_of: test/data_structure/segment_tree/3.test.cpp
layout: document
redirect_from:
- /verify/test/data_structure/segment_tree/3.test.cpp
- /verify/test/data_structure/segment_tree/3.test.cpp.html
